...
export function ReviewFormSection({ businessName }: { businessName: string }) {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    window.setTimeout(() => setSubmit({ status: "idle" }), 2500);
  }
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <div className="space-y-4 lg:col-span-2">
            ...
            {submit.status !== "idle" ? (
              ...
              >
                {submit.status === "pending"
                  ? "Submitting your review (demo)…"
                  : "Review submitted (demo). Thanks for sharing."}
              </div>
            ) : null}
          </div>
        </div>
